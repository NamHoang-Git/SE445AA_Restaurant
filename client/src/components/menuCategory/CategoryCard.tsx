        ...
        <div className="block rounded-[28px] backdrop-glass border border-input p-2">
            <div>
                ...
                >
                    ...
                    <CardContent className="p-3 relative z-10 text-foreground flex flex-col gap-1.5 justify-between h-[120px] sm:h-32 w-full">
                        <h3 className="font-semibold transition-colors duration-300 line-clamp-2 h-fit w-full">
                            {data.name}
                        </h3>
