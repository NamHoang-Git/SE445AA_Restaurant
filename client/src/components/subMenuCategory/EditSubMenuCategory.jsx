...
const UploadSubMenuCategoryModel = ({
    close,
    fetchData,
    data: SubMenuCategoryData,
}) => {
    const [subMenuCategoryData, setSubMenuCategoryData] = useState({
        _id: SubMenuCategoryData._id,
        name: SubMenuCategoryData.name,
        image: SubMenuCategoryData.image,
        description: SubMenuCategoryData.description,
        parentCategory: SubMenuCategoryData.parentCategory,
    });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await Axios({
                ...SummaryApi.update_sub_menu_category,
                data: subMenuCategoryData,
            });
